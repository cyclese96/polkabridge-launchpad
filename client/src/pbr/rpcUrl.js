...
export const moonriverNodes = ['https://rpc.moonriver.moonbeam.network']

export const moonbaseAlphaTestnet = ['https://rpc.testnet.moonbeam.network']

export const astarRpcNodes = [
